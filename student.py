...
class Student:
    def __init__(self, root):
        ...
        # # Image 2
        # img2 = Image.open("./college_images/St1.jpg")
        ...
        course_combo = ttk.Combobox(current_course_frame, textvariable=self.var_course,
                                    font=("times new roman", 13, "bold"), width=17,
                                    state="readonly")
        ...
        update_btn = Button(btn_frame, command=self.update_data, text="Update", width=19,
                            font=("times new roman", 12, "bold"), bg="blue",
                            fg="white")
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, command=self.delete_data, text="Delete", width=19,
                            font=("times new roman", 12, "bold"), bg="blue",
                            fg="white")
        delete_btn.grid(row=0, column=2)

        reset_btn = Button(btn_frame, command=self.reset_data, text="Reset", width=19,
                           font=("times new roman", 12, "bold"), bg="blue",
                           fg="white")
        ...
        take_photo_btn = Button(btn_frame1, command=self.generate_dataset, text="Take Photo Sample", width=39, font=("times new roman", 12, "bold"),
                                bg="blue",
                                fg="white")
        take_photo_btn.grid(row=0, column=0)

        update_photo_btn = Button(btn_frame1, text="Update Photo Sample", width=38,
                                  font=("times new roman", 12, "bold"),
                                  bg="blue",
                                  fg="white")
        ...
        Right_frame = LabelFrame(main_frame, bd=2, relief=RIDGE, text="Student Details",
                                 font=("times new roman", 12, "bold"))
        Right_frame.place(x=735, y=10, width=765, height=580)
        ...
        showAll_btn = Button(Search_frame, text="ShowAll", width=12, font=("times new roman", 12, "bold"), bg="blue",
                             fg="white")
        ...
        "roll", "course", "year", "sem", "id", "dep", "name", "div", "gender", "dob", "phone", "address", "email",
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        "update student set Roll=%s,course=%s,Year=%s,Semester=%s, Dep=%s, Name=%s,Division=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s, Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",
                        (
                            self.var_roll.get(),
                            self.var_course.get(),
                            self.var_year.get(),
    ...
    def generate_dataset(self):
        ...
        print("Photos capture completed!")
